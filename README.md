# Diffusion Models for High-Resolution Face Generation & Reconstruction (PyTorch DDPM)
...
1. Create a new Kaggle notebook with GPU (T4 / dual T4 if available).
2. Add FFHQ dataset as input.
3. Run notebook cells in order:
   ...
   - gradio app
4. For best sampling quality, use:
...
If this repo helped you, consider starring it and sharing feedback.
